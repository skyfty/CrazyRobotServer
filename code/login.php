...
if ($res['code']==1) {  
    ...
    $stmt->execute([$openid, 0, 0, '[{"id": "1", "level": 1}]','[{"id": 1, "level": 0}, {"id": 2, "level": 0}, {"id": 3, "level": 0}, {"id": 4, "level": 0}, {"id": 5, "level": 0}, {"id": 6, "level": 0}, {"id": 7, "level": 0}]','[{"id": 0}, {"id": 0}, {"id": 0}, {"id": 0}, {"id": 0}]']);  
