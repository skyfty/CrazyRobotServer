...
{
    protected $noNeedLogin = ['login', 'mobilelogin', 'register', 'resetpwd', 'changeemail', 'changemobile', 'third', 'loginregister','WXLogin','initUserData'];
    ...
    public function WXLogin()
    {
        ...
        // 调用微信登录接口
        $result = $this->auth->loginByWechat($code);
        if(!$result){
            $this->error($this->auth->getError());
        }
        //在data中添加code
